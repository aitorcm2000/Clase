...
CREATE TABLE `automoviles` (
 ...
 `alquilado` TINYINT(4) NOT NULL, PRIMARY KEY (`matricula`)
...
/*!40000 ALTER TABLE `automoviles` ENABLE KEYS */; UNLOCK TABLES;
...
CREATE TABLE `clientes` (
 ...
 `fnac` DATE DEFAULT NULL, PRIMARY KEY (`dni`)
...
/*!40000 ALTER TABLE `clientes` ENABLE KEYS */; UNLOCK TABLES;
...
CREATE TABLE `contratos` (
 ...
 `kfin` INT(11) DEFAULT NULL, PRIMARY KEY (`numcontrato`), KEY `fk_contrato_auto` (`matricula`), KEY `fk_contrato_cliente` (`dnicliente`), CONSTRAINT `fk_contrato_auto` FOREIGN KEY (`matricula`) REFERENCES `automoviles` (`matricula`) ON
DELETE NO ACTION ON
UPDATE CASCADE, CONSTRAINT `fk_contrato_cliente` FOREIGN KEY (`dnicliente`) REFERENCES `clientes` (`dni`) ON
DELETE NO ACTION ON
UPDATE CASCADE
...
/*!40000 ALTER TABLE `contratos` ENABLE KEYS */; UNLOCK TABLES;
...
CREATE TABLE `contratos2` (
 ...
 `ffin` DATE DEFAULT NULL,
 `kini` INT(11) NOT NULL,
 `kfin` INT(11) DEFAULT NULL, PRIMARY KEY (`numcontrato`), KEY `k_matricula` (`matricula`), KEY `k_dni` (`dnicliente`), CONSTRAINT `fk_contrato2_automovil` FOREIGN KEY (`matricula`) REFERENCES `automoviles` (`matricula`) ON
DELETE NO ACTION ON
UPDATE CASCADE, CONSTRAINT `fk_contrato2_cliente` FOREIGN KEY (`dnicliente`) REFERENCES `clientes` (`dni`) ON
DELETE NO ACTION ON
UPDATE CASCADE
...
/*!40000 ALTER TABLE `contratos2` ENABLE KEYS */; UNLOCK TABLES;
